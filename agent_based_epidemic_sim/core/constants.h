...
inline const std::array<float, kMaxDaysAfterInfection + 1> kInfectivityArray = {
    0.0005190573909275743, 0.01789205231287749,
    0.08197704117195806,   0.15942404868622712,
    0.19639311438282891,   0.18291684433819838,
    0.1411785741577649,    0.095234136299998,
    0.05806124055356765,   0.03271863716715262,
    0.017312313915856636,  0.008700469912807929,
    0.004188825154643472,  0};
